...
const char* ssid = "RaspiSpot";             // SSID of the modem that is placed in Laboratory. You may change it according to used modem.
const char* password = "Mechatronics402";   // Password of the modem that is placed in Laboratory. You may change it according to used modem.
